...
En este post, te mostraré cómo instalar [Ghost CMS](https://ghost.org) en [Fly.io](https://Fly.io) con la [integración para alojar imágenes en Cloudinary](https://github.com/eexit/ghost-storage-cloudinary) que Ghost recomienda. T̵o̵d̵o̵ ̵e̵s̵t̵o̵ ̵d̵e̵ ̵m̵a̵n̵e̵r̵a̵ ̵g̵r̵a̵t̵u̵i̵t̵a̵
...
[Link del repositorio aquí →](https://github.com/dandelior/fly-ghost-cloudinary)
...
Nos pedirá el nombre de la app. Aquí usamos el nombre que ingresamos en url, por ejemplo, si ingresamos _https://el-blog-de-messi.fly.dev_ acá debemos ingresar `el-blog-de-messi`
...
Y eso es todo, Ghost CMS estará ahora configurado con Cloudinary en [Fly.io](https://Fly.io) de manera gratuita y tu sitio web estará disponible en la url especificada en el archivo `fly.toml`. Asegúrate de seguir las instrucciones cuidadosamente y si tienes alguna pregunta o problema, mi twitter es @[dandelior](https://twitter.com/dandelior). Disfruta tu nuevo sitio 🔥.
