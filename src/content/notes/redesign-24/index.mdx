...
Por último, y como mencione anteriormente estuve usando [Contentlayer](/notes/contentlayer) en la versión anterior, en cambio, ahora no necesito ninguna dependencia externa para manejar mi contenido en MDX, ya que Astro lo trae by default.
